...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, res_path, device, num_layers):
...
def ResNet18_OS16(res_path, device):
    return ResNet_BasicBlock_OS16(res_path, device, num_layers=18)

def ResNet34_OS16(res_path, device):
    return ResNet_BasicBlock_OS16(res_path, device, num_layers=34)

def ResNet50_OS16(res_path, device):
    return ResNet_Bottleneck_OS16(res_path, device, num_layers=50)

def ResNet101_OS16(res_path, device):
    return ResNet_Bottleneck_OS16(res_path, device, num_layers=101)

def ResNet152_OS16(res_path, device):
    return ResNet_Bottleneck_OS16(res_path, device, num_layers=152)

def ResNet18_OS8(res_path, device):
    return ResNet_BasicBlock_OS8(res_path, device, num_layers=18)

def ResNet34_OS8(res_path, device):
    return ResNet_BasicBlock_OS8(res_path, device, num_layers=34)
